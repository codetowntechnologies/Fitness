            ...
            <View style={styles.container}>
                ...
                <View style={{
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.buttonWhiteTextStyle}>Done</Text>

                    </TouchableOpacity>

                    <Text style={styles.forgotpasswordtext} onPress={() => this.props.navigation.navigate('Dashboard')}>Forgot Password?</Text>
